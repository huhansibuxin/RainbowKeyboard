...
RainbowKeyboard_FILES := RKKeyboardHooks.xm RKAdaptivePerformance.m Tweak.xm RainbowEffectView.m RKNeonPress.m RKThemeEngine.m RKKeyboardGeometry.m RKBlackBitmap.m CandidateGradient.xm PureBlackKeyboard.xm
